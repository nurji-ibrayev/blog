...
@section('title')Eyeball.kz - Контакты@endsection
    ...
    <div class="container" id="contact">
        ...
        <div class="product_view">
            ...
            <div class="product_information">
                ...
                <a href="tel:+77710346106">+7 (771) 034 6106</a>
                <br>
                <label>E-mail:</label>
                <a href="mailto:eyeball.kz@gmail.com">eyeball.kz@gmail.com</a>
                <br>
                <label>Instagram:</label>
                <a href="https://www.instagram.com/">
                    <svg class="top_logo" viewbox="0 0 169.063 169.063" height="25" style="vertical-align: middle; margin: 5px 10px 5px 0;">
